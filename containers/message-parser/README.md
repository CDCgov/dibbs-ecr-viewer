...
2. Download a copy of the Docker image from the dibbs-ecr-viewer repository by running `docker pull ghcr.io/cdcgov/dibbs-ecr-viewer/message-parser:latest`.
...
To build the Docker image for the Message Parser from source instead of downloading it from the dibbs-ecr-viewer repository follow these steps.
