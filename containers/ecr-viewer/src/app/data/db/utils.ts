...
export type DbUtils = {
  schemaExistsByName: (kysely: Kysely<any>, schemaName: string) => Promise<boolean>;
  tableExistsByName: (kysely: Kysely<any>, schemaName: string, tableName: string) => Promise<boolean>;
  columnExistsByName: (kysely: Kysely<any>, schemaName: string, tableName: string, columnName: string) => Promise<boolean>;
  getColumn: (kysely: Kysely<any>, schemaName: string, tableName: string, columnName: string) => Promise<any>;
  getTable: (kysely: Kysely<any>, schemaName: string, tableName: string) => Promise<any>;
