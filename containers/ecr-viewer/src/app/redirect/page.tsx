 ...
 *
 * Displays a login prompt for users trying to access the eCR Viewer.
 * @returns A styled page with prompt text and a login button that redirects users to Azure AD authentication.
 */
const RedirectPage = () => {
  return (
    <div
