...
/**
 * Add condition_id column and foreign key constraint to ecr_rr_conditions.
...
export async function up(db: Kysely<AnyDb>): Promise<void> {
  ...
  await _db.schema
    ...
    .addColumn("condition_id", "varchar(20)", (cb) =>
...
/**
 * Roll back condition_id addition to ecr_rr_conditions.
 * @param db - the database connection
 */
