...
const labReportNormalJsonObject = {
  ...
  resultName:
    "Stool Pathogens, NAAT, 12 to 25 Targets (09/28/1822 1:51 PM PDT)",
  tables: [
    [
      {
        Component: {
      ...
      },
      {
        ...
        "Analysis Time": {
          value: (
            <p>
              <span>09/28/1822 1:59:00 PM PDT</span>
            </p>
          ),
          metadata: {},
        },
...
describe("Labs Utils", () => {
          ...
          [
            {
              ...
              "Lab Test Result Date": {
                metadata: {},
                value: <span>1825-02-04T21:02:00.000Z</span>,
              },
  ...
  describe("searchResultRecord", () => {
    ...
    it("extracts string of all results of a search for specified lab report", () => {
      ...
      const expectedResult = "09/28/1822 1:51 PM GMT-6:59:56";
  ...
  describe("returnAnalysisTime", () => {
    it("extracts and formats correct field value from within a lab report", () => {
      ...
      expect(result).toEqual("09/28/1822 4:59\u00A0PM\u00A0EDT");
    });
    ...
    it("Concats date times if multiple passed", () => {
      ...
      expect(result).toEqual(
        "09/28/1822 4:59\u00A0PM\u00A0EDT, 09/28/1822 5:59\u00A0PM\u00A0EDT",
      );
    });
