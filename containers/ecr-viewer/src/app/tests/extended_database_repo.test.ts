...
describe('ecr_data', () => {
  ...
  it('should update patient_name_last of a person with a given id', async () => {
    await extended_database_repo.updateExtendedEcr("12345", { last_name: 'Grievous' })
  })
...
describe('ecr_labs', () => {
  beforeAll(async () => {
    await db.schema.createTable('ecr_labs')
      .addColumn('uuid', 'varchar(200)', (cb) => cb.primaryKey())
  ...
  it('should update the lab with a given id', async () => {
    await extended_database_repo.updateLab("12345", { test_result_code: 'FAIL' })
  })
...
describe('ecr_rr_conditions', () => {
  ...
  it('should update the condition with a given id', async () => {
    await extended_database_repo.updateEcrCondition("12345", { condition: 'Extra Dark Magic' })
  })
...
describe('ecr_rr_rule_summaries', () => {
  ...
  it('should update the rule summary with a given id', async () => {
    await extended_database_repo.updateEcrRule("12345", { rule_summary: 'Extra Dark Magic' })
  })
