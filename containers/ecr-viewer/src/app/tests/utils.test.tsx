...
import BundleWithTravelHistoryEmpty from "./../../../../../test-data/BundleTravelHistoryEmpty.json";
import BundleWithPatient from "./../../../../../test-data/BundlePatient.json";
import BundleWithDeceasedPatient from "./../../../../../test-data/BundlePatientDeceased.json";
import BundleWithSexualOrientation from "./../../../../../test-data/BundleSexualOrientation.json";
import BundleWithMiscNotes from "./../../../../../test-data/BundleMiscNotes.json";
import BundleWithPendingResultsOnly from "./../../../../../test-data/BundlePendingResultsOnly.json";
import BundleWithScheduledOrdersOnly from "./../../../../../test-data/BundleScheduledOrdersOnly.json";
import BundleNoActiveProblems from "./../../../../../test-data/BundleNoActiveProblems.json";
import BundleCareTeam from "./../../../../../test-data/BundleCareTeam.json";
