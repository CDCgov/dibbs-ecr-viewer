...
[View the Setup Guide](https://cdcgov.github.io/dibbs-ecr-viewer/documents/Setup_Guide.html#general-background) for information about the available configurations.
...
For managed deployments, environment variables are set through the Terraform/ACA configuration. Use the [Setup Guide](https://cdcgov.github.io/dibbs-ecr-viewer/documents/Setup_Guide.html) and [Environment variable reference](https://cdcgov.github.io/dibbs-ecr-viewer/modules/environment.EnvironmentVariables.html) to determine:
