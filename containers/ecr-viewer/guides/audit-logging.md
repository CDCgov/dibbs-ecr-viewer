...
- The audit event creation timestamp is synchronously generated by the database at the time of write to the database, in the same transaction as the auditted action, within 5 seconds of the event occurring
