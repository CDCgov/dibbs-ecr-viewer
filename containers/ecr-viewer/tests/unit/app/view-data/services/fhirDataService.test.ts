...
jest.mock("@/app/data/blobStorage/utils", () => {
  const originalModule = jest.requireActual("@/app/data/blobStorage/utils");
  return {
    ...originalModule,
...
describe("getFhirData", () => {
  ...
  it("should return a 500 response when METADATA_DATABASE_TYPE is invalid", async () => {
    ...
    const response = await getFhirData({ eicr_id: "123" });
  ...
  describe("gcp", () => {
    ...
    it("should return 200 when the file is found", async () => {
      ...
      const response = await getFhirData({ eicr_id: "1234" });
...
describe("getS3", () => {
  ...
  it("should return ecr when database query succeeds", async () => {
    ...
    const response = await getS3("123");
...
describe("getAzure", () => {
  ...
  it("should return ecr when database query succeeds", async () => {
    ...
    const response = await getAzure("123");
  ...
  it("should be called by getFhirData when source is azure", async () => {
