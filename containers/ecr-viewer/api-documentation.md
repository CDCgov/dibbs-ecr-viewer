...
the state of the application, including updating the conditions used in the viewer to match the Trigger Reference Service. It can also be used to revert migrations and return the database to a prior state.
