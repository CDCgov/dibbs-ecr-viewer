...
Please consult the [eCR Viewer Setup Guide](./Setup%20Guide.md) to verify that your environment variables and infrastructure have been configured correctly.
...
- You’ve set the appropriate environment variables for your configuration based on the [setup guide](./Setup%20Guide.md#environment-variable-setup).
